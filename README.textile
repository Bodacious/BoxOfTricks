...
p. To get this working, all you need is an XML sitemap feed with a route helper named "sitemap_url". Then, all you have to do is add the name of the model(s) you want to observe to the observe method and restart your app.
